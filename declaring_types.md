...
Sometimes you have objects where you don't know the key names up front (maybe just the values). In cases like this it's useful to use Typescript's [Indexable Types](https://www.typescriptlang.org/docs/handbook/interfaces.html#indexable-types):
