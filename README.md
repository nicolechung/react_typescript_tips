...
### Todos
[Why is my build so slow?](slow_build.md)
[Why can't I use the type `any`?](no_implict_any.md)
[Why don't my imports work like a normal React project?](allow_synthetic_imports.md)
